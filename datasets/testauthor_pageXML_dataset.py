...
if __name__ == "__main__":
    ...
    if len(sys.argv)>3:
        ...
        repeat=1
    data=author_pageXML_dataset.AuthorPageXMLLinesDataset(dirPath=dirPath,split='test',config={
        'img_height': 64,
        'max_width': 1300,
    ...
    dataLoader = torch.utils.data.DataLoader(data, batch_size=4, shuffle=True, num_workers=0, collate_fn=author_pageXML_dataset.collate)
